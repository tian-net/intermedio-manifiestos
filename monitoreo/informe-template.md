...
| 6 | Dashboard sigue mostrando "No data" en MongoDB y JVM | Nombres de métricas en queries del dashboard no coinciden con los reales del exporter y el backend | Corregir 7 queries en dashboard: `mongodb_database_collection_size_bytes`→`mongodb_dbstats_dataSize`, `jvm_memory_used_bytes`→`jvm_memory_committed_bytes`, agregar label `application="Elchino"` | `monitoreo/grafana/grafana-dashboard-configmap.yaml` |
